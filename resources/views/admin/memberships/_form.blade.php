...
<div>
    ...
    <p class="mt-1 text-xs text-olive/60">مثال: 1 نقطة لكل شيكل لغير الأعضاء، 1.25 للأساسية، 1.5 للمميزة. يظهر للزبون كنسبة نقاط لكل مبلغ اكتساب الذي يحدده الأدمن.</p>
</div>
<div>
